      ...
      <main className="container mx-auto px-4 py-6">
        <Tabs defaultValue="navigate" className="w-full" onValueChange={handleTabChange}>
          ...
          <TabsContent value="explore">
            ...
            {/* Guía del estadio: buscador + mapa de asientos + secciones */}
            {/* Search bar */}
            ...
            <div className="grid lg:grid-cols-5 gap-6">
              ...
              {/* Columna izquierda: mapa de asientos del estadio */}
              <div className="lg:col-span-3">
                <div className="rounded-xl overflow-hidden border border-border bg-card">
                  <div
                    className="relative cursor-pointer group"
                ...
                {/* Mobile: secciones debajo del mapa de asientos */}
              ...
              {/* Columna derecha (web only): secciones del estadio */}
