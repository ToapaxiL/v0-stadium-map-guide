...
export const PLACE_CATEGORIES: PlaceCategory[] = [
  {
    ...
    places: [
      {
        id: 1,
        nombre: "Pharma Center",
        address: "Quito, Ecuador",
        lat: -0.1067950527514329,
        lng: -78.49227199031257,
        maps: "https://maps.app.goo.gl/1sJT86vXUJGGkDRA8",
        tag: "Farmacia",
      },
      {
        id: 2,
        ...
        lat: -0.1087944,
        lng: -78.4930755,
        maps: "https://maps.app.goo.gl/ntMQC9cuMs8pHR2H9",
        tag: "Farmacia",
      },
      {
        id: 3,
        nombre: "Fybeca Da Vinci",
        address: "Quito, Ecuador",
        lat: -0.1046491,
        lng: -78.4914398,
        maps: "https://maps.app.goo.gl/QNLbVksk7UvemCwf7",
        tag: "Farmacia",
      },
      {
        id: 4,
        nombre: "Farmacia Económica Quito Diego de Vázquez",
        address: "Diego de Vásquez, Quito",
        lat: -0.1110492,
        lng: -78.4895358,
        maps: "https://maps.app.goo.gl/QjZdScFyznWGvDW77",
        tag: "Farmacia",
      },
      {
        id: 5,
        ...
        lat: -0.1043941,
        lng: -78.4915386,
        maps: "https://maps.app.goo.gl/v7cPKW67wHdQPc3L9",
        tag: "Farmacia",
      },
    ],
  },
